...
def resolver_sistema():
    ...
    if opcion == "1":
        ...
        print("4. Gauss")
        print("5. Escalonada")
        print("6. Escalonada Reducida")
        metodo = input("Ingrese opción (1/2/3/4/5/6): ")
        ...
        if metodo == "1":
            ...
            print("\nResolviendo por Escalonada...")
            resultado = metodos.escalonada(coef)  # devuelve matriz transformada
            entrada.imprimir_matriz(resultado)

        elif metodo == "6":
            print("\nResolviendo por Escalonada Reducida...")
            resultado = metodos.escalonada_reducida(coef)  # devuelve matriz transformada
            entrada.imprimir_matriz(resultado)
